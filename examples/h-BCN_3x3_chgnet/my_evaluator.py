"""Custom energy evaluator using CHGNet."""
...
def get_chgnet_calculator():
    """Load the CHGNet calculator once and reuse it for all samples."""
...
def run_chgnet_calculation(sample_id, structure_id):
    ...
    Build the structure, relax it with CHGNet, and return its energy.
    Returns:

# h-BCN 3x3 Example with UMA

This example demonstrates PyAPX's custom energy-evaluator interface, where a
user-defined Python function relaxes h-BCN 3x3 candidate structures with UMA and
returns the relaxed total energy.
...
- `my_evaluator.py`: User-defined energy-evaluator function using ASE and UMA.
...
Place the UMA model checkpoint in this directory:
